...
@interface YTEngagementPanelHeaderView : UIView <GA11YMixinEmbedder, YTPageStyling>
{
    ...
    YTFormattedStringLabel *_contextualInfoLabel;
...
@property(retain, nonatomic) YTFormattedStringLabel *contextualInfoLabel; // @synthesize contextualInfoLabel=_contextualInfoLabel;
