...
@property(readonly, nonatomic) __weak id <YTOfflineServices> offlineServices; // @synthesize offlineServices=_offlineServices;
...
- (_Bool)isCreatePlaylist;
- (_Bool)isAddToPlaylist;
- (id)playlistID;
- (id)videoID;
- (void)didTapCancel;
...
- (void)dealloc;
- (id)initWithServices:(id)arg1 offlineServices:(id)arg2 identityController:(id)arg3 parentResponder:(id)arg4;
