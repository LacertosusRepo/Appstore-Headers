...
@class NSString, YTOfflineVideoController, YTPlaylistPanelControlsView;
...
- (void)setVideoCountText:(id)arg1 videoCountHidden:(_Bool)arg2 shuffleEnabled:(_Bool)arg3 shuffleSelected:(_Bool)arg4 loopEnabled:(_Bool)arg5 loopSelected:(_Bool)arg6 saveEnabled:(_Bool)arg7 shareEnabled:(_Bool)arg8 saveSelected:(_Bool)arg9 actionEnabled:(_Bool)arg10 infiniteList:(_Bool)arg11;
