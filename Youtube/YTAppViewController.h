...
#import "YTPageStyleControllerDelegate.h"
...
@class GIMMe, NSArray, NSMutableArray, NSString, UIView<YTAppRootContainer>, YTAdFeedbackController, YTAppEventHandler, YTAppModalController, YTAppOfflineVideoController, YTAppPivotBarController, YTAppPopoverController, YTAppPushController, YTAppWatchController, YTBottomOffsetController, YTConfirmDialogController, YTConnectionBarController, YTConnectionStatusController, YTDarkThemePromoViewController, YTFancyDismissibleDialogController, YTPageStyleController, YTPivotBarViewController, YTPromosheetController, YTScrollableNavigationController, YTSearchViewController, YTSlideBackController;

@interface YTAppViewController : YTMultiSizeViewController <YTAppRootContainerPageStyleDelegate, YTColorObserver, YTConnectionStatusControllerDelegate, YTConnectionBarControllerObserver, YTInlinePlaybackLayoutProtocol, YTInnerTubeCollectionAppearanceResponderProvider, UINavigationControllerDelegate, YTPageStyleControllerDelegate, YTStorageControllerObserver, YTStyleContextResponderProvider, YTSystemNotificationsObserver, YTUserChangedObserver, YTAppRootSlice, YTPivotBarProvider, YTResponderRoot, YTScrollBubbleBehaviorProvider, YTTopViewControllerProvider, YTNavigationProtocol>
{
    ...
    YTConnectionBarController *_connectionBarController;
...
- (struct CGRect)appViewFrameWithWindowBounds:(struct CGRect)arg1;
- (id)appEventHandler;
...
- (void)backWithCompletion:(CDUnknownBlockType)arg1 logBackTransition:(_Bool)arg2;
- (void)back;
- (void)shutdown;
- (void)load;
...
- (_Bool)isValidPageColorTheme:(unsigned long long)arg1;
...
@property(nonatomic) __weak id <YTPlayerServices> playerServices;
