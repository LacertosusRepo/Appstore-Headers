...
@class NSString, UIView, YTBadge, YTFormattedStringLabel, YTIAThumbnailDetails, YTIRedCarpetPlaylistVideoRenderer, YTImageView, YTRedCarpetBadgeView, YTShadowView, YTTransferButton;
...
@interface YTRedCarpetPlaylistVideoCell : YTCollectionViewCell <GA11YMixinEmbedder, YTThumbnailMapping, YTCollectionViewCellProtocol>
{
    ...
    YTIAThumbnailDetails *_thumbnailIconDetails;
