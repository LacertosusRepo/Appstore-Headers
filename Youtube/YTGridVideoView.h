...
@class NSArray, NSDate, NSString, UIButton, UIView, YTBadgesView, YTFormattedStringLabel, YTIButtonRenderer, YTImageView, YTLabel, YTProgressOverlayView, YTQTMButton, YTStandaloneBadgeView, YTVideoSubtitleView, YTVideoThumbnailView;
