...
#import "YTIPlaylistCardRenderer.h"

#import "YTVideoCardModel.h"

@class NSMutableArray, NSString, YTIAThumbnailDetails, YTICommand, YTIFormattedString, YTIMenuSupportedRenderers, YTIStandaloneBadgeSupportedRenderers, YTIVideoCardStyle;

@interface YTIPlaylistCardRenderer (YTVideoCardModel) <YTVideoCardModel>
