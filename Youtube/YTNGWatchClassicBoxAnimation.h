...
@class CADisplayLink, NSString, UIView, YTNGWatchLayerView<YTNGWatchClassicBoxAnimationDelegate>;

@interface YTNGWatchClassicBoxAnimation : NSObject <YTNGWatchAnimation>
{
    YTNGWatchLayerView<YTNGWatchClassicBoxAnimationDelegate> *_animationDelegate;
    UIView *_playerViewParentView;
    ...
    struct CGRect _finalClassicBoxFrame;
