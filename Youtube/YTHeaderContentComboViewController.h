...
#import "YTHeaderViewActionListener.h"
...
@interface YTHeaderContentComboViewController : YTStyledViewController <YTPlaybackRouteButtonVisibilityObserver, YTColorObserver, YTGuideServiceCoordinatorObserver, YTTopBarResponderProvider, YTUserChangedObserver, YTHeaderViewActionListener, YTRendererController, YTGraftingViewController, YTHelpKitContextProvider, YTHidePivotBarOnSearchProtocol, YTNavigationalLatencyProtocol, YTPageStyling, YTTopController, YTTopScrolling>
{
...
- (void)showTopbarUploadButton;
- (void)setRightButtons;
- (_Bool)hasBackButton;
- (void)setupLogo;
- (void)initializeButtons;
- (void)didLongPressOnHeaderView:(id)arg1;
