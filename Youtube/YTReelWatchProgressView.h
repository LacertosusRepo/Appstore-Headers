...
- (void)layoutSubviews;
- (void)resetProgressBarAtIndex:(unsigned long long)arg1;
- (void)pauseProgressBarAtIndex:(unsigned long long)arg1;
- (void)focusIndex:(long long)arg1 animated:(_Bool)arg2;
- (void)animateProgressBarAtIndex:(unsigned long long)arg1 duration:(double)arg2;
