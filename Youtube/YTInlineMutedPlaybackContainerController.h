...
#import "YTInlineMutedPlaybackWatchControllerDelegate.h"
#import "YTResponder.h"
#import "YTScrollFocusableItemDelegate.h"

@class GIMMe, NSString, YTInlineMutedPlaybackStateController, YTInlineMutedPlaybackViewControllerManager, YTInlineMutedPlaybackWatchController, YTInteractionLoggingProxyButton;

@interface YTInlineMutedPlaybackContainerController : NSObject <YTGraftingViewController, YTInlineMutedPlaybackWatchControllerDelegate, YTScrollFocusableItemDelegate, YTResponder>
{
    YTInlineMutedPlaybackViewControllerManager *_impVCManager;
    double _watchRestartThreshold;
    _Bool _entryRemoved;
    _Bool _isInlineMutedInceptionEnabled;
    _Bool _isInlineMutedAutoAdvanceEnabled;
...
- (id)initWithEntry:(id)arg1 parentResponder:(id)arg2 playbackItem:(id)arg3;
