...
@class GIMMe, NSString, UIView, UIView<YTReelItemViewProtocol>, UIView<YTReelWatchTransitionItem>, YTIReelItemRenderer;

@interface YTReelItemCell : YTCollectionViewCell <YTCollectionViewCellProtocol, YTDismissableCellProtocol, YTThumbnailMapping>
{
