...
#import "YTCommonCacheDelegate.h"
#import "YTNGWatchControllerDelegate.h"
#import "YTNGWatchFlowControllerDelegate.h"
#import "YTNGWatchQueueResponderProvider.h"
#import "YTResponder.h"
#import "YTSystemNotificationsObserver.h"
#import "YTWatchQueueProtocol.h"

@class GIMMe, NSArray, NSHashTable, NSMutableArray, NSMutableDictionary, NSString, UIViewController<YTWatchViewControllerProtocol>, YTNGWPlayerPrefetchQueueController, YTStickyVarispeedController, YTWatchTransition;

@interface YTNGWatchQueue : NSObject <YTCommonCacheDelegate, YTNGWatchControllerDelegate, YTSystemNotificationsObserver, YTNGWatchFlowControllerDelegate, YTNGWatchQueueResponderProvider, YTResponder, YTWatchQueueProtocol>
{
    NSHashTable *_observers;
    id <YTCommonCacheSynchronous><YTCommonCache> _lruCache;
    YTNGWPlayerPrefetchQueueController *_playerPrefetchQueueController;
    NSArray *_lastAppliedNavigationListEntries;
    NSArray *_lastAppliedUpNextEntries;
    long long _lastAppliedCurrentIndex;
    ...
    NSMutableDictionary *_currentNavigationMap;
}

@property(retain, nonatomic) NSMutableDictionary *currentNavigationMap; // @synthesize currentNavigationMap=_currentNavigationMap;
...
- (id)queueNavEntryIDs;
- (void)notifyObserversDidUpdateItemsAtInsertionIndexes:(id)arg1 deletionIndexes:(id)arg2;
...
- (id)mergedQueueWithUpdatedTransitions:(id)arg1 newCurrentIndex:(long long)arg2 navigationMap:(id)arg3;
- (id)pruneNavigationMap:(id)arg1 withUpdatedTransitions:(id)arg2 newCurrentIndex:(unsigned long long)arg3;
- (id)navListEntriesWithRange:(struct _NSRange)arg1;
...
- (void)clearQueueAroundCurrentIndex;
- (void)clearQueue;
- (void)preloadWatchControllerAtIndex:(long long)arg1;
- (void)handleRemoteControlEvent:(long long)arg1;
- (id)currentWatchTransition;
- (long long)indexForWatchTransition:(id)arg1;
- (void)removeObserver:(id)arg1;
- (void)addObserver:(id)arg1;
- (long long)queueCount;
- (void)prepareForWatchTransition:(id)arg1 expectedLayout:(id)arg2;
- (void)appendWatchTransition:(id)arg1;
- (void)updateAndApplyWatchTransition:(id)arg1 atIndex:(long long)arg2;
- (void)setPrevWatchTransition:(id)arg1;
- (void)setNextWatchTransition:(id)arg1;
