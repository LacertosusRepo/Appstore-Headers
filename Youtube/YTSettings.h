...
@class GIMMe, MLAudioQualityConfig, NSArray, NSDate, NSDictionary, NSHashTable, NSNumber, NSString, YTColdConfig, YTIMdxGlobalConfig, YTInnerTubeConfigs, YTUserDefaults;
...
@property(readonly, nonatomic) _Bool isCowatchEnabled;
...
@property(nonatomic) _Bool enableOfflinePlaylistAutoSync;
...
- (void)setInitialFormatHDOnWiFiOnly:(_Bool)arg1;
