...
@class GIMMe, NSError, NSString, UIViewController<YTPlaybackController>, YTDefaultPlayerOverlayFactory, YTHotConfig, YTICommand, YTInlineMutedPlaybackOverlayFactory, YTInlineMutedPlaybackViewControllerManager, YTInlineMutedPlaybackWatchViewController, YTPlayerResponse, YTTimedAction, YTUserDefaults, YTWatchTransition;
...
- (void)resignPlaybackAsync:(_Bool)arg1;
- (_Bool)canIncept;
