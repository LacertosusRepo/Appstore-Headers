...
@class GIMMe, MDXScreenManager, NSString, YTMDXPreviewController, YTWatchTransition;

@interface YTMDXScreenContentController : NSObject <MDXScreenManagerObserver, MDXScreenSessionObserver, YTMDXPreviewControllerDelegate, YTResponder, YTWatchQueueProtocol>
{
...
- (void)MDXScreenManager:(id)arg1 didReceiveMDXPlaybackEndpoint:(id)arg2;
