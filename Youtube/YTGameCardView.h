...
@class FLXLayout, NSString, UILongPressGestureRecognizer, UITapGestureRecognizer, YTFormattedStringLabel, YTNotificationMultiToggleButton, YTNotificationOptionsButton, YTNotificationPreferenceToggleButton, YTQTMButton, YTSubscribeSwitch, YTVideoThumbnailView;
...
@property(retain, nonatomic) YTVideoThumbnailView *boxArt; // @synthesize boxArt=_boxArt;
@property(retain, nonatomic) UITapGestureRecognizer *cardTapRecognizer; // @synthesize cardTapRecognizer=_cardTapRecognizer;
@property(nonatomic) _Bool shouldResetLayout; // @synthesize shouldResetLayout=_shouldResetLayout;
