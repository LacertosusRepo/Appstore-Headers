...
@interface YTReelLibraryViewController : YTEditEffectTakeoverViewController <YTCollectionViewScrollObserver, YTUploadCameraRollCollectionViewControllerDelegate, YTEditFeatureTab, YTTopController>
{
    YTICommand *_model;
