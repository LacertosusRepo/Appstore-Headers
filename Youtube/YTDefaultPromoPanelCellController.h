...
@interface YTDefaultPromoPanelCellController : YTInnerTubeCellController <YTCarouselPlayablePanel, YTDefaultPromoPanelViewDelegate, YTVideoAsThumbnailDetailsDelegate>
{
    id <YTCellPaddingResponderProvider> _paddingProvider;
