...
@class NSArray, YTIAThumbnailDetails, YTIFormattedString, YTIGridPromotedVideoCTASupportedRenderers, YTIRenderer, YTIStandaloneBadgeSupportedRenderers, YTIUpcomingEventData;
