...
#import "GSCAccountsExternalSourceDelegate.h"
#import "GSCAccountsService.h"
#import "GSCSingleForegroundAccountsService.h"
#import "SRLConfigurableService.h"

@class GOOAccountScopedProvider, NSMutableDictionary, NSMutableOrderedSet, NSObject<OS_dispatch_queue>, NSString, PHSBroadcast;
...
{
    CDUnknownBlockType _currentSSOIdentityBlock;
...
- (void)updateForegroundAccountFromAppSourceWithPreviousAccount:(id)arg1;
- (void)maybeUpdateForegroundAccountIdFromAppSource;
