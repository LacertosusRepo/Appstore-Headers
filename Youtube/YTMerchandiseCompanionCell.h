...
@class MDCInkTouchController, NSString, UIImageView, UITapGestureRecognizer, UIView, YTButton, YTIMerchandiseShelfRenderer, YTImageView, YTLabel;
...
@interface YTMerchandiseCompanionCell : YTCollectionViewCell <YTPageStyling, YTCellActionProtocol, YTCollectionViewCellProtocol, YTThumbnailMapping>
{
    ...
    YTButton *_merchandiseButton;
    YTButton *_sponsoredButton;
