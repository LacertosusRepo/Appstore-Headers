...
#import "YTNGWatchMiniBarControlsViewDelegate.h"
#import "YTPageStyling.h"

@class NSString, UIImageView, UIPanGestureRecognizer, UITapGestureRecognizer, YTNGWatchMiniBarControlsView, YTNGWatchMiniBarVideoView, YTProgressView;

@interface YTNGWatchMiniBarView : UIView <GA11YMixinEmbedder, UIGestureRecognizerDelegate, YTNGWatchMiniBarControlsViewDelegate, YTPageStyling>
{
    ...
    _Bool _adPlaying;
    UIImageView *_classicBoxBorderImageView;
    _Bool _animating;
