...
- (void)showUpsellDialogWithUpsell:(id)arg1 videoID:(id)arg2 playlistID:(id)arg3 upsellParentResponder:(id)arg4;
- (void)showUpsell:(id)arg1 videoID:(id)arg2 playlistID:(id)arg3 toastType:(int)arg4 upsellParentResponder:(id)arg5;
- (void)dealloc;
