...
@class GIMMe, NSString, UIWindow, YTActionCapturingWindow, YTAppViewController, YTCrashController, YTQuickActionsController, YTSafeModeController, YTSettings, YTUserDefaults, YTUserIDProvider;
...
- (void)performPrecriticalInitializationWithApplicationState:(long long)arg1;
