...
@class GIMMe, GOOKeyboardWatcher, NSString, YTEditMetadataTitleValidator, YTIReelCreationMetadataEndpoint, YTReelCreationViewControllerView, YTThumbnailController;

@interface YTReelCreationViewController : YTStyledViewController <GOOTextFieldValidator, UITextFieldDelegate, YTTopController>
{
