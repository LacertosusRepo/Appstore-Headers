...
@interface IMConversionProfilesOverviewController : IMVideoDetailSettingsController <IMTableViewDelegate, UITableViewDataSource>
{
...
- (void)selectProfileForMode:(int)arg1;
