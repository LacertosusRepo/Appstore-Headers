...
@class SPTDataLoaderFactory, SPTFreeTierTasteOnboardingCurator, SPTFreeTierTasteOnboardingDeeplinkStore, SPTFreeTierTasteOnboardingLoggerFactory, SPTFreeTierTasteOnboardingTheme, SPTNetworkConnectivityController, SPTPopupManager;
@protocol SPTAudioPreviewPlayer, SPTCollectionPlatform, SPTFollowModelFactory, SPTFreeTierTasteOnboardingTestManager, SPTGLUEImageLoaderFactory, SPTInstrumentationModalPresentationMonitor, SPTLoginStateController, SPTMandatoryPremiumTrialService, SPTMetaViewController, SPTModalPresentationController, SPTPerformanceMetricsViewLoggerFactory;
