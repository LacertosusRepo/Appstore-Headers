...
@interface BMWRemotingSession : EOCSession
{
    id <BMWRemotingSessionDelegate> _delegate;
}

+ (id)serviceNames;
@property __weak id <BMWRemotingSessionDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
