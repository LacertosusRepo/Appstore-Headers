...
#import "SPTHomeConsolidateViewModelDelegate-Protocol.h"

@class NSString;
@protocol EXP_HUBContentOperationDelegate;

@interface SPTHomeConsolidateRemoveComponentContentOperation : NSObject <SPTHomeConsolidateViewModelDelegate, EXP_HUBContentOperation>
{
