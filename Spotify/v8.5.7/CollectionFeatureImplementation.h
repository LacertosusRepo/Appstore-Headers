...
@interface CollectionFeatureImplementation : NSObject <SPTService, CollectionFeature>
{
    ...
    id <SPTFeatureFlagSignal> _consolidatedAlbumEnabledSignal;
...
@property(retain, nonatomic) id <SPTFeatureFlagSignal> consolidatedAlbumEnabledSignal; // @synthesize consolidatedAlbumEnabledSignal=_consolidatedAlbumEnabledSignal;
...
- (void)unregisterCollectionAlbumPage;
- (void)unregisterPages;
- (void)unload;
- (void)registerCollectionArtistPage;
- (void)registerCollectionAlbumPage;
- (void)registerPages;
- (void)setUpManagers;
- (void)load;
