...
@protocol SPTCollectionPlatformConfiguration, SPTFreeTierPlaylistDefaultHeaderViewModel, SPTFreeTierPlaylistFollowViewModel, SPTFreeTierPlaylistPlayViewModel, SPTGaiaUserInterfaceContextObserver, SPTImageLoader;
...
- (void)notifyGaiaThatHeaderDidScroll;
- (_Bool)shouldNotifyGaia;
...
- (id)createHeaderView;
- (id)initWithHeaderViewModel:(id)arg1 playViewModel:(id)arg2 followViewModel:(id)arg3 imageLoader:(id)arg4 collectionConfiguration:(id)arg5 filterSearchBar:(id)arg6 theme:(id)arg7 logger:(id)arg8 gaiaObserverService:(id)arg9;
