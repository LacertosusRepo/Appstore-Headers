...
@protocol SPTLyricsLineProgressManager, SPTLyricsV2LyricsViewControllerDelegate, SPTLyricsV2LyricsViewStyleProvider;
...
- (void)viewDidLoad;
- (void)loadView;
- (id)initWithStyleProvider:(id)arg1 progressManager:(id)arg2;
