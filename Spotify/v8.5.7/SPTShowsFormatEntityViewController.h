...
@class NSMutableArray, NSString, NSURL, SPTEntityHeaderViewController, SPTProgressView, SPTShareScreenshotObserverManager, SPTShowsFormatEntityView, SPTShowsFormatEntityViewDataSource, SPTShowsFormatEntityViewDelegate, SPTShowsFormatEntityViewModel, SPTShowsFormatLogger, SPTVISREFShowsHeaderController, VISREFIntegrationManager;
@protocol SPContextMenuFeature, SPTAlertController, SPTBarButtonItemManager, SPTCollectionPlatformTestManager, SPTContextMenuPresenter, SPTEntityHeaderContentController><SPTShowsFormatEntityHeaderContentViewControllerProtocol, SPTImageLoaderFactory, SPTPageContainer, SPTPodcastContextMenuProvider, SPTShareFeature, SPTShowsFormatVideoContextMenuProvider;
...
@interface SPTShowsFormatEntityViewController : UIViewController <SPTBarButtonItemManagerObserver, SPTShowsFormatEntityViewModelDelegate, SPTContextMenuPresenterDelegate, SPTShareableContext, SPTShareScreenshotObserverManagerDataSource, SPTPageController>
{
    ...
    UIViewController<SPTEntityHeaderContentController><SPTShowsFormatEntityHeaderContentViewControllerProtocol> *_headerContentViewController;
    id <SPTContextMenuPresenter> _contextMenuPresenter;
    SPTProgressView *_progressView;
    NSMutableArray *_pendingBlocksAfterDataIsLoaded;
    id <SPTAlertController> _alertController;
    SPTVISREFShowsHeaderController *_headerController;
...
@property(retain, nonatomic) SPTVISREFShowsHeaderController *headerController; // @synthesize headerController=_headerController;
...
@property(retain, nonatomic) UIViewController<SPTEntityHeaderContentController><SPTShowsFormatEntityHeaderContentViewControllerProtocol> *headerContentViewController; // @synthesize headerContentViewController=_headerContentViewController;
...
- (void)loadView;
- (void)dealloc;
- (id)initWithViewModel:(id)arg1 viewDataSource:(id)arg2 viewDelegate:(id)arg3 imageLoaderFactory:(id)arg4 contextMenuFeature:(id)arg5 podcastContextMenuProvider:(id)arg6 videoContextMenuProvider:(id)arg7 barButtonItemManager:(id)arg8 logger:(id)arg9 contextAwareSharingEnabled:(_Bool)arg10 collectionTestManager:(id)arg11 shareFeature:(id)arg12 alertController:(id)arg13 visualRefreshIntegrationManager:(id)arg14;
