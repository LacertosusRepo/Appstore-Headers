...
- (void)testManager:(id)arg1 didUpdateWatchAppContextPageUIFixEnabledState:(_Bool)arg2;
- (void)testManager:(id)arg1 didUpdateWatchAppContextPageEnabledState:(_Bool)arg2;
