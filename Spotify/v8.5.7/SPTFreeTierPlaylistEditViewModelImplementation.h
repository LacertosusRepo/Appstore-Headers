...
@protocol SPTCollectionPlatformConfiguration, SPTFreeTierPlaylistEditViewModelDelegate, SPTFreeTierPlaylistModel, SPTFreeTierPlaylistTestManager, SPTVISREFFlagsService;
...
- (id)initWithPlaylistModel:(id)arg1 collectionConfiguration:(id)arg2 testManager:(id)arg3 visualRefreshService:(id)arg4;
