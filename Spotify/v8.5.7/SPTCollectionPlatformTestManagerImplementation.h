...
@property(readonly, nonatomic) id <SPTFeatureFlagSignal> doubleTabYourlibraryEnabledSignal; // @synthesize doubleTabYourlibraryEnabledSignal=_doubleTabYourlibraryEnabledSignal;
...
- (void)setupYourLibraryDoubleTabSignal;
...
- (void)dealloc;
- (id)initWithProductState:(id)arg1 abbaFeatureFlags:(id)arg2 localSettings:(id)arg3 settingsRegistry:(id)arg4 featureSettingsItemFactory:(id)arg5 featureFlagFactory:(id)arg6 freeTierEnabledSignal:(id)arg7 doubleTabYourlibraryEnabledSignal:(id)arg8 freeTierTestManager:(id)arg9 snackbarPresenter:(id)arg10 nowPlayingTestManager:(id)arg11;
