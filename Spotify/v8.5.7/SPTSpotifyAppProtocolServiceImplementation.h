...
@protocol SPTAccessoryManagerService, SPTAccessoryStateManager, SPTAppProtocolConnector, SPTCoreService, SPTExternalIntegrationDebugLog, SPTExternalIntegrationDebugLogService, SPTExternalIntegrationPlatform, SPTGaiaConnectAPI, SPTNetworkService, SPTProductState;
