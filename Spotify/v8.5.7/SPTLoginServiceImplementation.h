...
@class NSError, NSString, SPTAllocationContext, SPTAuthenticationHandler, SPTLoginAttemptLogger, SPTLoginDialogController, SPTLoginErrorDecorator, SPTLoginKeychainManagerImplementation, SPTLoginLogoutAwaiter, SPTLoginStateControllerImplementation, SPTObserverManager;
