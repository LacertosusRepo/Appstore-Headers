...
- (id)initWithGaiaManager:(id)arg1 storage:(id)arg2 logCenter:(id)arg3 settingsFlags:(id)arg4 savedDeviceManager:(id)arg5 linkDispatcher:(id)arg6 logger:(id)arg7 deviceConfiguration:(id)arg8;
