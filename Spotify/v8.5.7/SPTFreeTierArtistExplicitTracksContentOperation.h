...
@protocol EXP_HUBContentOperationDelegate, SPTExplicitContentAccessManager;

@interface SPTFreeTierArtistExplicitTracksContentOperation : NSObject <EXP_HUBContentOperation>
{
