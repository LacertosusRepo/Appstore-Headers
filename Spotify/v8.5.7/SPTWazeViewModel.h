...
- (void)updateState;
- (void)dealloc;
- (id)initWithWazeTransportManager:(id)arg1 drivingStateDetector:(id)arg2 linkDispatcher:(id)arg3 debugLog:(id)arg4 testManager:(id)arg5 bannerSessionLogger:(id)arg6 wazeLogger:(id)arg7 showBannerInitally:(_Bool)arg8 autoLockController:(id)arg9 notificationCenter:(id)arg10 partnerTestManager:(id)arg11;
