...
@protocol SPContextMenuFeature, SPTContextMenuPresenter, SPTGaiaDevicePickerPresenter, SPTLinkDispatcher, SPTNowPlayingLegacyFeedbackCoordinator, SPTNowPlayingManager, SPTNowPlayingModeResolver, SPTNowPlayingTestManager, SPTPodcastContextMenuProvider, SPTPodcastSpeedControlManager, SPTQueueLogger, SPTSleepTimerController, SPTSleepTimerService, SPTUIPresentationService;
...
- (void)handleFreeTierNegativeFeedbackWithConfirmation:(_Bool)arg1;
