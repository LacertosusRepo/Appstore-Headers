...
@protocol SPTNowPlayingContentCellDelegate, SPTNowPlayingContentCellRefreshDelegate, SPTNowPlayingCoverArtContentView, SPTVideoSurface;
...
- (void)layoutSubviews;
- (id)initWithFrame:(struct CGRect)arg1 videoSurfaceManager:(id)arg2 defaultFrame:(struct CGRect)arg3;
