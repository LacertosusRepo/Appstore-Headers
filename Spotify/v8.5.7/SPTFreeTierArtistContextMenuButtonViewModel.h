...
@protocol SPTContextMenuActionsProvider, SPTContextMenuPresenter, SPTContextMenuPresenterFactory, SPTFollowModelFactory, SPTFreeTierArtistTestManager, SPTFreeTierEntityContextMenuButtonViewModelDelegate;
...
- (id)initWithPresenterFactory:(id)arg1 actionFactory:(id)arg2 freeTierArtistTestManager:(id)arg3 artistURI:(id)arg4 followModelFactory:(id)arg5;
