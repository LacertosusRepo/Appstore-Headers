...
@protocol GLUEImageLoader, SPTAudioPreviewModelFactory, SPTAudioPreviewUIFactory, SPTCollectionPlatformConfiguration, SPTFreeTierCollectionSongCellConfiguratorDelegate, SPTShelves;
...
- (void)dealloc;
- (id)initWithImageLoader:(id)arg1 theme:(id)arg2 collectionConfiguration:(id)arg3 audioPreviewModelFactory:(id)arg4 audioPreviewUIFactory:(id)arg5 shelves:(id)arg6;
