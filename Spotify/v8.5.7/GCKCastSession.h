...
@class GCKAnalyticsEventLogger, GCKApplicationMetadata, GCKBWeakListenerList, GCKCastDeviceController, GCKCastOptions, GCKDevice, GCKDiscoveryManager, GCKError, GCKSessionEndpoint, NSDictionary, NSMutableArray, NSSet, NSString;
