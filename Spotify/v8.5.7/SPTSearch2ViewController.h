...
@class GLUEGradientView, NSString, NSURL, SPTProgressView, SPTSearch2Configuration, SPTSearchHubViewController, SPTSearchPlatformColorInterpolator;
@protocol GLUETheme, SPTExplicitContentHubCommandHandlerFactory, SPTImageLoader, SPTPageContainer, SPTSearch2ViewModelProvider, SPTSearchLoadingLogger;

@interface SPTSearch2ViewController : UIViewController <SPContentInsetViewController, SPTSearch2ViewModelProviderDelegate, EXP_HUBViewContentOffsetObserver, SPTImageLoaderDelegate, EXP_SPTHubPlayTrackListCommandHandlerDelegate, SPTSearchPlatformColorInterpolatorDelegate, SPTPageController, SPTSearch2ViewControllerProtocol>
{
...
- (void).cxx_destruct;
- (_Bool)shouldLoadNextPageOnScroll;
- (id)makeSeeMoreResultsCommandHandlerWithSearchLogger:(id)arg1;
