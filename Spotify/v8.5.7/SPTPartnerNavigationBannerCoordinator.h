...
@protocol SPTBannerPresentationManager, SPTBannerPresentationManagerTicket, SPTDrivingStateDetector, SPTLinkDispatcher, SPTNowPlayingManager, SPTNowPlayingStateObservable;

@interface SPTPartnerNavigationBannerCoordinator : NSObject <SPTPartnerNavigationIntegrationObserver, SPTDrivingStateObserver, SPTPartnerNavigationBannerViewModelActionHandler, SPTNowPlayingStateObserver>
{
...
- (id)initWithDrivingDetector:(id)arg1 integrationLoader:(id)arg2 bannerPresenter:(id)arg3 linkDispatcher:(id)arg4 nowPlayingManager:(id)arg5 nowPlayingStateObservable:(id)arg6 testManager:(id)arg7;
