...
@protocol SPTGaiaConnectAPI, SPTGaiaLockScreenControlsStateProvider, SPTImageLoader, SPTLocalSettings, SPTPlayer;
...
- (id)placeholderImage;
- (void)dealloc;
- (id)initWithPlaybackController:(id)arg1 trackMetadataQueue:(id)arg2 connectManager:(id)arg3 localSettings:(id)arg4 infoCenter:(id)arg5 imageLoader:(id)arg6 lockScreenControlsStateProvider:(id)arg7 player:(id)arg8;
