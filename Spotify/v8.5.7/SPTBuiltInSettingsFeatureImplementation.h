...
@protocol CosmosFeature, ProfileFeature, SPTAbbaFeatureFlags, SPTAbbaService, SPTBannerFeature, SPTContainerService, SPTContainerUIService, SPTCoreService, SPTDataSaverService, SPTDebugService, SPTFeatureFlagSignal, SPTFreeTierService, SPTHomeFeature, SPTInAppMessageService, SPTLoginService, SPTNetworkService, SPTSessionService, SPTSettingsDataSource, SPTSettingsFeature, SPTURIDispatchService, SPTVoiceService;
...
@property(nonatomic) __weak id <SPTHomeFeature> homeFeature; // @synthesize homeFeature=_homeFeature;
