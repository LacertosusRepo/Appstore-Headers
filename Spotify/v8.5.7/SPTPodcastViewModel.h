...
@class NSArray, NSPredicate, NSSortDescriptor, NSString, NSURL, SPTPodcastSortingService;
@protocol SPTCollectionPlatform, SPTExplicitContentAccessManager, SPTFreeTierEntityFeedbackButtonViewModel, SPTPodcast, SPTPodcastDataLoader, SPTPodcastDataLoaderRequestToken, SPTPodcastFactory, SPTPodcastLogger, SPTPodcastPlayer, SPTPodcastTestManager, SPTPodcastViewModelDelegate;

@interface SPTPodcastViewModel : NSObject <SPTExplicitContentEnabledStateObserver, SPTPodcastPlayerDelegate, SPTCollectionSorting, SPTCollectionFiltering>
{
...
- (void)dealloc;
- (id)initWithPodcastURL:(id)arg1 dataLoader:(id)arg2 player:(id)arg3 sortingService:(id)arg4 logger:(id)arg5 collectionPlatform:(id)arg6 explicitContentAccessManager:(id)arg7 testManager:(id)arg8;
