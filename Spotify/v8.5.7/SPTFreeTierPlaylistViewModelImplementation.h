...
@class NSArray, NSDate, NSString, NSURL, SPTFreeTierPlaylistLogger, SPTFreeTierPlaylistTrackShuffler, SPTPlayOrigin, SPTPlayerState, UIColor;
...
@property(copy, nonatomic) NSArray *shuffledCloudTracks; // @synthesize shuffledCloudTracks=_shuffledCloudTracks;
...
- (void)toggleFollow;
@property(readonly, nonatomic) _Bool headerShouldShowFollowButton;
