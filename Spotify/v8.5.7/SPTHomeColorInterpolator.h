...
@protocol SPTHomeColorInterpolatorDelegate;

@interface SPTHomeColorInterpolator : NSObject
{
    id <SPTHomeColorInterpolatorDelegate> _delegate;
...
@property(nonatomic) __weak id <SPTHomeColorInterpolatorDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
