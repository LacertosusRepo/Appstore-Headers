...
@protocol EXP_HUBContentOperationDelegate, SPTFollowModelFactory;

@interface SPTFreeTierArtistBannedTracksContentOperation : NSObject <EXP_HUBContentOperation, FollowModelObserver>
{
