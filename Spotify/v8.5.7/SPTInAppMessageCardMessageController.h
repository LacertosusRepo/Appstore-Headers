...
@protocol SPTExternalIntegrationDriverDistractionController, SPTOfflineModeState, SPTSlateBuilderProvider, SPTSlateManager;
...
- (id)initWithParser:(id)arg1 slateManager:(id)arg2 slateBuilderProvider:(id)arg3 actionFactory:(id)arg4 serviceLogger:(id)arg5 driverDistractionController:(id)arg6 offlineModeState:(id)arg7 feedbackPresentationController:(id)arg8;
