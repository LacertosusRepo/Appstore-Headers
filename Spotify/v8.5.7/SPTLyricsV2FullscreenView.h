...
@interface SPTLyricsV2FullscreenView : UIView
{
    ...
    struct CGRect _collapsedLyricsViewFrame;
    struct CGRect _collapsedCardViewFrame;
}
...
@property(nonatomic) struct CGRect collapsedCardViewFrame; // @synthesize collapsedCardViewFrame=_collapsedCardViewFrame;
@property(nonatomic) struct CGRect collapsedLyricsViewFrame; // @synthesize collapsedLyricsViewFrame=_collapsedLyricsViewFrame;
