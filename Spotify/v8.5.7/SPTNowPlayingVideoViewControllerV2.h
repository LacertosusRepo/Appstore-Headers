...
@class NSString, SPTNowPlayingBaseHeadUnitController, SPTNowPlayingLogger, SPTNowPlayingSkipLimitReachedMessageRequester, SPTNowPlayingVideoHeadUnitViewController, SPTNowPlayingVideoTimer, SPTNowPlayingVideoViewModelV2, SPTNowPlayingVideoViewV2, SPTStatusBarToken, SPTTheme, UIView;
@protocol SPTLinkDispatcher, SPTLocalSettings, SPTPodcastContextMenuProvider, SPTQueueLogger, SPTVideoSurfaceManager;
