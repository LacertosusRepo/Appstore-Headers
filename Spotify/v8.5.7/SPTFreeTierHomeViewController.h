...
#import "SPTFreeTierHomeViewModelProviderDelegate-Protocol.h"
#import "SPTNavigationControllerNavigationBarState-Protocol.h"
#import "SPTPageController-Protocol.h"
#import "SPTScrollToTopViewController-Protocol.h"
#import "SPViewController-Protocol.h"

@class EXP_HUBComponentRegistry, NSString, NSURL, SPTFreeTierHomeNavigationItemDecorator, SPTFreeTierHomeView, SPTFreeTierHomeViewModelProvider, SPTProgressView, UIView;
@protocol EXP_HUBComponentEventHandler, EXP_HUBComponentLayoutManager, EXP_HUBImageLoaderFactory, EXP_SPTHubImpressionLogger, EXP_SPTHubLoadingLogger, GLUETheme, SPTOfflineModeState, SPTPageContainer;

@interface SPTFreeTierHomeViewController : UIViewController <EXP_SPTHubViewModelProviderDelegate, SPTScrollToTopViewController, EXP_HUBViewContentOffsetObserver, EXP_HUBViewComponentDelegate, EXP_HUBOverlayViewComponentDelegate, SPContentInsetViewController, SPTPageController, SPTNavigationControllerNavigationBarState, SPViewController, SPTFreeTierHomeViewModelProviderDelegate>
{
    NSString *_pageIdentifier;
    NSURL *_pageURI;
    SPTFreeTierHomeNavigationItemDecorator *_navigationItemDecorator;
    SPTFreeTierHomeViewModelProvider *_viewModelProvider;
    id <GLUETheme> _theme;
    NSURL *_viewURI;
...
@property(readonly, nonatomic) SPTFreeTierHomeViewModelProvider *viewModelProvider; // @synthesize viewModelProvider=_viewModelProvider;
...
- (void)viewDidLoad;
- (void)loadView;
- (id)initWithTheme:(id)arg1 viewURI:(id)arg2 componentRegistry:(id)arg3 componentLayoutManager:(id)arg4 imageLoaderFactory:(id)arg5 commandHandler:(id)arg6 viewModelProvider:(id)arg7 loadingLogger:(id)arg8 impressionLogger:(id)arg9 offlineModeState:(id)arg10;
