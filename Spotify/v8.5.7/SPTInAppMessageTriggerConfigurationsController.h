...
@protocol SPTInAppMessageTriggerConfigurationsControllerDelegate, SPTInAppMessageTriggerConfigurationsControllerObserver, SPTOfflineModeState;

@interface SPTInAppMessageTriggerConfigurationsController : NSObject <SPTInAppMessageTriggerConfigurationsPrerequisitesObserver, SPTDataLoaderDelegate, SPTInAppMessageFeatureFlagChecksObserver, SPTOfflineModeStateObserver, SPTInAppMessageTriggerEngineDelegate>
{
    _Bool _refreshing;
...
- (void)dealloc;
- (id)initWithPrerequisites:(id)arg1 configurationsDataLoader:(id)arg2 serviceLogger:(id)arg3 featureFlagChecker:(id)arg4 offlineModeState:(id)arg5;
