...
@class NSError, NSString, NSURL, SPTDataLoader, SPTHomeFeatureContentCache;
@protocol EXP_HUBContentOperationDelegate, EXP_HUBViewModelBuilder, SPTOfflineModeState;

@interface SPTHomeHTTPRemoteContentOperation : NSObject <SPTDataLoaderDelegate, SPTOfflineModeStateObserver, EXP_HUBContentOperation>
{
