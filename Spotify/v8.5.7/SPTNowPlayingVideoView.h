...
@class NSArray, NSString, SPTNowPlayingBaseHeadUnitView, SPTNowPlayingDurationView, SPTNowPlayingFullScreenVideoControlsConstraints, SPTNowPlayingNavigationBarView, SPTNowPlayingNavigationButtonsView, SPTNowPlayingVideoFooterView, SPTNowPlayingVideoHeaderView, SPTTheme, UIActivityIndicatorView;
