...
@protocol SPContextMenuFeature, SPTAbbaService, SPTAddToPlaylistService, SPTAdsService, SPTBannerFeature, SPTBrowsePlatformService, SPTBrowseRedirectButtonProvider, SPTCollectionLogger, SPTCollectionPlatformService, SPTCollectionSortingEntityManager, SPTContainerService, SPTContainerUIService, SPTCoreService, SPTExplicitContentService, SPTFeatureFlaggingService, SPTFormatListPlatformRegistration, SPTFormatListPlatformService, SPTFreeTierService, SPTGLUEService, SPTInstrumentationService, SPTNavigationFeature, SPTNetworkService, SPTNuxService, SPTPageRegistrationToken, SPTPerformanceMetricsService, SPTPlayerFeature, SPTPlaylistExtenderService, SPTPlaylistPlatformService, SPTSessionService, SPTSettingsFeature, SPTShareFeature, SPTShelfService, SPTSnackbarService, SPTSpotlightService, SPTUIPresentationService, SPTURIDispatchService, SPTYourLibraryService;
