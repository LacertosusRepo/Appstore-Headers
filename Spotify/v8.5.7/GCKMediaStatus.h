...
@class GCKAdBreakStatus, GCKMediaInformation, GCKMediaQueueData, GCKMediaQueueItem, GCKMediaSeekableRange, GCKVideoInfo, NSArray, NSMutableArray, NSMutableDictionary;
