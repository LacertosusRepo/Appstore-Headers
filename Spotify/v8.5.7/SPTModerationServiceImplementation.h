...
@protocol SPContextMenuFeature, SPTCoreService, SPTFeatureFlaggingService, SPTGLUEService, SPTNetworkService, SPTPlayerFeature, SPTSessionService, SPTSettingsFeature, SPTUIPresentationService, SPTURIDispatchService, SPTWebViewFeature;
...
- (id)createFeatureSettingsRegistrar;
