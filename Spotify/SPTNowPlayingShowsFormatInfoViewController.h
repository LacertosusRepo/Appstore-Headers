...
- (void)loadView;
- (void)dealloc;
- (id)initWithModel:(id)arg1 theme:(id)arg2 contextMenuFeature:(id)arg3 contextMenuProvider:(id)arg4 linkDispatcher:(id)arg5 logger:(id)arg6 testManager:(id)arg7 collectionTestManager:(id)arg8;
