...
@class NSLayoutConstraint, NSString, SPTNowPlayingDurationViewV2, SPTNowPlayingHeadUnitViewV2, SPTNowPlayingNavigationBarView, SPTNowPlayingNavigationButtonsView, SPTNowPlayingVideoFooterView, SPTNowPlayingVideoHeaderView, SPTTheme, UIActivityIndicatorView, UIView<SPTVideoSurface>;
