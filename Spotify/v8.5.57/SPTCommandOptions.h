...
@interface SPTCommandOptions : NSObject <NSCopying>
{
    _Bool _overrideRestrictions;
    _Bool _onlyForLocalDevice;
    _Bool _systemInitiated;
}

@property(nonatomic) _Bool systemInitiated; // @synthesize systemInitiated=_systemInitiated;
@property(nonatomic) _Bool onlyForLocalDevice; // @synthesize onlyForLocalDevice=_onlyForLocalDevice;
