...
#import "SPTSearchUICarouselChildSizingDelegate-Protocol.h"

@class NSSet, NSString;
@protocol HUBComponentChildDelegate;

@interface SPTSearchUICarouselComponent : HUGSThemableComponent <SPTSearchUICarouselChildSizingDelegate, HUBComponent, HUBComponentWithChildren>
{
