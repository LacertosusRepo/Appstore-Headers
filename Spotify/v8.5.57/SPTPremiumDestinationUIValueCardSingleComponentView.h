...
@class GLUELabel, NSLayoutConstraint, SPTPremiumDestinationUIGLUETheme, SPTPremiumDestinationUIValueCardSingleStyle, UIImageView;

@interface SPTPremiumDestinationUIValueCardSingleComponentView : HUBComponentView <HUBComponentViewWithImageHandling>
{
    SPTPremiumDestinationUIGLUETheme *_theme;
    SPTPremiumDestinationUIValueCardSingleStyle *_style;
