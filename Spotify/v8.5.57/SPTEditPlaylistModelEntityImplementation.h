...
#import "SPTEditPlaylistModelEntity-Protocol.h"

@class NSArray, NSString;
@protocol SPTEditPlaylistModelEntityMetadataFields;

@interface SPTEditPlaylistModelEntityImplementation : NSObject <SPTEditPlaylistModelEntity>
{
    id <SPTEditPlaylistModelEntityMetadataFields> _metadata;
    NSArray *_tracks;
