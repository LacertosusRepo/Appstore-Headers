...
@class GLUECollectionViewStyle, GLUEGradientStyle, NSString, SPTFreeTierTasteOnboardingArtistSearchCollectionViewLayoutStyle<GLUEStyle>, UIColor, UIFont, UIImage;
