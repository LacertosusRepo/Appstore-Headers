...
@interface SPTFreeTierTasteOnboardingTrackSwipeIntroCell : UICollectionViewCell <GLUEStyleable>
{
    _Bool _newlyCreated;
...
@property(retain, nonatomic) NSDictionary *textLabelEdgeConstraints; // @synthesize textLabelEdgeConstraints=_textLabelEdgeConstraints;
