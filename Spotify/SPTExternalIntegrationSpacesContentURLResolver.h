...
- (void).cxx_destruct;
- (id)remoteHubContentURLForEndpointPath:(id)arg1 forExternalData:(_Bool)arg2 includeDynamicComponents:(_Bool)arg3;
- (id)remoteHubContentURLWithoutDynamicComponentsForSpacesEndpointPath;
