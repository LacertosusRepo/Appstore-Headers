...
@interface SPTProfileViewController : SPViewController <SPTProfileViewModelDelegate, SPTProfileCountsViewDelegate, SPObjectRepresentation, SPViewController, SPContentInsetViewController, SPTNavigationControllerNavigationBarState, SPTEntityHeaderBarButtonItemsProtocol, UITableViewDelegate, SPTPageController>
{
