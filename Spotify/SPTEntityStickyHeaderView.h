...
@class CAGradientLayer, GLUEButton, NSString, SPTEntityTableHeaderBackgroundView, SPTEntityTableHeaderView, UIButton, UIImage, UILabel;

@interface SPTEntityStickyHeaderView : UIView <SPTThemableView>
{
    _Bool _shouldDisplayAlternateTitle;
    _Bool _shouldDisplayTopRightAccessoryButton;
...
@property(nonatomic) _Bool shouldDisplayTopRightAccessoryButton; // @synthesize shouldDisplayTopRightAccessoryButton=_shouldDisplayTopRightAccessoryButton;
