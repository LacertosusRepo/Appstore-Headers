...
@class NSArray, NSString, NSURL, SPTNowPlayingCarouselGradientView, SPTNowPlayingHeartIndicatorView, SPTNowPlayingTestManager, SPTNowPlayingVideoTimer, SPTPlayerTrack, UIActivityIndicatorView, UIButton, UIImage, UIImageView, UIView<SPTNowPlayingCoverArtContentView>, UIView<SPTVideoSurface>;
