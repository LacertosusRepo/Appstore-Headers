...
@class NSMutableData, NSObject<OS_dispatch_queue>, NSURLSessionTask, SPTDataLoaderExponentialTimer, SPTDataLoaderRateLimiter, SPTDataLoaderRequest, SPTDataLoaderResponse;
