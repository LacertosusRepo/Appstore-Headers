...
@class NSString, SPTContextMenuMaskView, SPTContextMenuViewCancelButton, SPTTableView, SPTUIBlurView, UIPanGestureRecognizer, UITapGestureRecognizer;
...
- (_Bool)shouldLoadImageForAction:(id)arg1;
- (void)loadImageForAction:(id)arg1 cell:(id)arg2 indexPath:(id)arg3;
