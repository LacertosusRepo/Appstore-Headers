...
@class GLUEImageView, NSArray, NSLayoutConstraint, NSMutableArray, NSString, SPTLayoutConstraintBuilder, SPTOfflineSyncStatusView, SPTTheme, UILabel, UIProgressView, UIView;

@interface SPTPodcastEpisodeViewV1 : GLUEStatefulView <SPTPodcastEpisodeView>
{
    _Bool _editing;
    ...
    NSMutableArray *_editingTrailingAccessoryConstraints;
    NSMutableArray *_trailingAccessoryConstraints;
}

@property(retain, nonatomic) NSMutableArray *trailingAccessoryConstraints; // @synthesize trailingAccessoryConstraints=_trailingAccessoryConstraints;
@property(retain, nonatomic) NSMutableArray *editingTrailingAccessoryConstraints; // @synthesize editingTrailingAccessoryConstraints=_editingTrailingAccessoryConstraints;
...
- (void)addEditingMainActionViewToViewHierarchy;
- (void)addMainActionViewToViewHierarchy;
