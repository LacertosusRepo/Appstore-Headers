...
@property(readonly, nonatomic) NSURL *sourceImage; // @synthesize sourceImage=_sourceImage;
@property(readonly, nonatomic) NSURL *sourceLink; // @synthesize sourceLink=_sourceLink;
