...
- (void)dealloc;
- (id)initWithURI:(id)arg1 dateFormatterProvider:(id)arg2 entityResolver:(id)arg3 imageLoader:(id)arg4 URLOpener:(id)arg5 theme:(id)arg6 glueImageLoader:(id)arg7 offlineModeState:(id)arg8 concertsLogger:(id)arg9 containerUIService:(id)arg10 showTicketViewInWebviewIsEnabled:(_Bool)arg11;
