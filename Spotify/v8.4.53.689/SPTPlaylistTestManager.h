...
- (void)dealloc;
- (id)initWithFeatureFlags:(id)arg1 productState:(id)arg2 localSettings:(id)arg3 freeTierEnabledSignal:(id)arg4 heartsEverywhereEnabledSignal:(id)arg5 featureFlagFactory:(id)arg6;
