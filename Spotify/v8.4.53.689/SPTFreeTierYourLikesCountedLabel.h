...
@class GLUELabel, NSLayoutConstraint, NSNumberFormatter, NSString, SPTFreeTierYourLikesCountedLabelStyle, UIStackView;

@interface SPTFreeTierYourLikesCountedLabel : GLUEStatefulView
{
    long long _count;
    NSString *_title;
...
@property(copy, nonatomic) SPTFreeTierYourLikesCountedLabelStyle *style; // @dynamic style;
