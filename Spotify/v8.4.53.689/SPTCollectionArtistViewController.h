...
@interface SPTCollectionArtistViewController : SPTableViewController <SPTImageLoaderDelegate, SPTNavigationControllerNavigationBarState, SPTProductStateObserver, SPTOfflineSwitchDelegate, SPTBarButtonItemManagerObserver, SPTEntityHeaderBarButtonItemsProtocol, SPTExplicitContentEnabledStateObserver, SPTCollectionArtistModelDelegate, SPTPageController>
{
