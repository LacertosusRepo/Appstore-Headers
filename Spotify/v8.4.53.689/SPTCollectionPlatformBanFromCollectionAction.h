...
- (id)logEventName;
- (id)title;
- (id)initWithLink:(id)arg1 collectionPlatform:(id)arg2 collectionTestManager:(id)arg3 collectionLogger:(id)arg4 wasBanned:(_Bool)arg5 logContext:(id)arg6 sourceURL:(id)arg7;
