...
@class NSArray, NSSet, NSString, SPTAccessory, SPTCarPlayContentItemBuilder, SPTCarPlayContentTreeCache, SPTCarPlayTestManager;
...
- (void)dealloc;
- (id)initWithContentDataSource:(id)arg1 testManager:(id)arg2 externalIntegrationPlatform:(id)arg3 mediaPlayerBridge:(id)arg4 gaiaFeature:(id)arg5 imageLoaderFactory:(id)arg6 debugLog:(id)arg7;
