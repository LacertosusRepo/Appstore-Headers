...
- (id)contextMenuPresenterForHeaderImageURL:(id)arg1 headerImagePlaceholder:(id)arg2 imageStyle:(long long)arg3 title:(id)arg4 subtitle:(id)arg5 metadataTitle:(id)arg6 actions:(id)arg7 entityURL:(id)arg8 trackURL:(id)arg9 headerSubtitleStlye:(long long)arg10 senderView:(id)arg11 options:(id)arg12;
- (id)contextMenuPresenterForHeaderImageURL:(id)arg1 headerImagePlaceholder:(id)arg2 imageStyle:(long long)arg3 title:(id)arg4 subtitle:(id)arg5 metadataTitle:(id)arg6 tasks:(id)arg7 entityURL:(id)arg8 trackURL:(id)arg9 headerSubtitleStlye:(long long)arg10 senderView:(id)arg11 options:(id)arg12;
