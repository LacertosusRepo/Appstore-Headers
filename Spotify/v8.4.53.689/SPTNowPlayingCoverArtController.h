...
@class NSString, SPTNowPlayingCarouselContentProviderRegistryImplementation, SPTNowPlayingCoverArtModel, SPTNowPlayingCoverArtView, SPTNowPlayingLogger, SPTNowPlayingTestManager;
...
- (id)initWithModel:(id)arg1 delegate:(id)arg2 coverArtView:(id)arg3 imageLoaderFactory:(id)arg4 videoSurfaceManager:(id)arg5 carouselRegistry:(id)arg6 logger:(id)arg7 nowPlayingVideoManager:(id)arg8 testManager:(id)arg9;
