...
@class GLUEButton, NSString, NSURL, SPTChartFreeTierNavigationBarModel, SPTChartFreeTierViewModel, SPTChartTheme, SPTEntityTableHeaderView, SPTTableView, UIView, UIViewController<SPTFreeTierRecommendationsPlaylistFooterViewController>;
